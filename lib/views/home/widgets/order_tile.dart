...
import 'package:foodly_driver/common/cached_network_image_container.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        controller.setTotalDistance = distanceToRestaurant + distanceFromRestaurantToClient;
        controller.setTotalDistanceFromRestaurantToClient = distanceFromRestaurantToClient;
                  ...
                  ClipRRect(
                    ...
                    child: SizedBox(
                        ...
                        child:CachedNetworkImageContainer(
                            imagePath: order.orderItems[0].foodId.imageUrl[0],
                            width: 85.h,
                            height: 80.h),),
                  ),
                  const SizedBox(
